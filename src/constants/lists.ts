...
export const PANGOLIN_LIST = 'https://raw.githubusercontent.com/dexdaddy/tokenlists/main/pangolin.tokenlist.json'
export const WAGMI_LIST = 'https://raw.githubusercontent.com/dexdaddy/tokenlists/main/wgm.tokenlist.json'

export const DEFAULT_TOKEN_LISTS_SELECTED: string[] = [PANGOLIN_LIST, WAGMI_LIST]

export const DEFAULT_TOKEN_LISTS: string[] = [PANGOLIN_LIST, WAGMI_LIST]
